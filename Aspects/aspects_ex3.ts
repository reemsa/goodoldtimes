//ex2 ask for decorater class but in typescript it not needed because it is type not as python which is typeless lan
//in this ex we need to iterate over all function without store name of function in array but in typescript there is no 
//function or module to get all global function 
var globall = require("global")
var documentt = require("global/document")
var windoww= require("global/window")
const fs = require('fs');
...
let x = Object.keys(windoww);
for(let i = 0; i < x.length; i++){
    console.log(x[i])
}
console.log(Object.keys(this.Function))
