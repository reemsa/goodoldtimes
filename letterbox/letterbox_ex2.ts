...
class DataStoregManeger{
    ...
    dispatch(massage:any[]) {
        ...
        if (massage[0] == "info") {
            this.infovar.info.call(new DataStoregManeger) 
        }
        else {
...
class StopWordManeger{
    ...
    dispatch(massage:any[]) {
        ...
        if (massage[0] == "info") {
            this.infovar.info.call(new StopWordManeger) 
        }
        else {
            throw new Error("massage invalid");
...
class WordFrequencyManeger{
    ...
    dispatch(massage:any[]) {
        ...
        if (massage[0] == "info") {
            this.infovar.info.call(new WordFrequencyManeger) 
        }
        else {
            throw new Error("massage invalid");
...
class WordFrequencyController{
    ...
    dispatch(massage:any[]) {
        ...
        if (massage[0] == "info") {
            this.infovar.info.call(new WordFrequencyController) 
        }
        else {
            throw new Error("massage invalid");
    ...
    init(file_path) {
        ...
        this.datastoragemanager.dispatch(["info"])
        this.stopmanager.dispatch(["info"])
        this.wordfreqmanager.dispatch(["info"])
